...
if len(sys.argv) != 6:
    print("Usage: python_script.py <model_path> <tensor_parallel_size> <system_prompt_path> <question_template_path> <dataset>")
    sys.exit(1)
...
config = run_config.RunConfig.from_paths(question_template_path, system_prompt_path, dataset, model_path, tensor_parallel_size)
